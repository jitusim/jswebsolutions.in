				...
				if(isset($success_status)){
			     ?>
                   <p class="alert alert-success" style="padding:10px;">
                      Post Edit successful... <strong>!!!</strong>
                    </p>
                ...
                <div class="col-lg-12" style="margin-bottom:50px;">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a class="btn btn-primary" href="<?php echo base_url("admin/post_function_list"); ?>">All Post Function List</a>
                        </div>
					...
					<p>
						...
						<div class="form-group">
						    <label>Title</label> 
                             <input type="hidden" name="post_edit_id" value="<?php if(!empty($post_function_details['id']))echo $post_function_details['id']; ?>">
						   <input type="text" name="title" class="form-control" placeholder="Enter title" id="title" value="<?php if(!empty($post_function_details['title']))echo $post_function_details['title']; ?>" /> 
						    
						</div>
						<div class="form-group">
						 <label>Details</label> 
						<textarea id="editor1" name="editor1" rows="100" cols="100">
                        <?php if(!empty($post_function_details['description']))echo $post_function_details['description']; ?>
                        </textarea>
						</div>
						<div class="form-group">
