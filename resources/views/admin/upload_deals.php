            ...
            <div class="row">
				...
				if(isset($success)){
			     ?>
                    ...
                    <script>setTimeout(function(){window.location.href = "<?php echo base_url("addPages"); ?>"; } , 1000);</script>
                 <?php 
			     }
              ...
              ?>  
                <div class="col-lg-12" style="margin-bottom:50px;">
					...
					<p>
						...
						<textarea id="editor1" name="editor1" rows="100" cols="100"><?php if(!empty($pageData))echo $pageData; ?></textarea>
						</div>
						<div class="form-group">
