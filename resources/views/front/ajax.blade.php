                            ...
                            <div class="row panel panel-default padding_div">
                                @if (!empty($post->image))
                                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                                        <img src="<?php echo url(" public/uploadsFiles/postImage/$post->image");
                                        ?>" alt="create ,Insert ,update,delete Opearation" class="img-thumbnail
                                        img-responsive">
                                    </div>
                                @endif
                                    ...
                                    <div>
                                        <a target="_blank" href='{{url("post/$post->title_url")}}' class="btn btn-default">Read more...</a>
                                            @if (!empty($post->demoUrl))
                                                <a target="_blank" href="{{$post->demoUrl}}" class="btn btn-default">
                                                See Demo
                                                </a>
                                            @endif
