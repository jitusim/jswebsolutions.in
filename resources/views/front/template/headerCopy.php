...
<head>
    ...
    <title>Home | JS Web solutions</title>
            ...
            <div class="navbar navbar-main">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="indexcopy.php">
                            <img class="logo-default" src="assets/image/logo.png" alt="logo" />
                            <img class="logo-retina" src="assets/image/logo-retina.png" alt="logo" />
                        </a>
                    </div>
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="phpCodeBlog.php" role="button">PHP</a>
                            </li>
                            <li>
                                <a href="javascriptCodeBlog.php" role="button">JAVA SCRIPT</a>
                            </li>
                             <li>
                                <a href="jQueryCodeBlog.php" role="button">JQUERY</a>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">FRAMEWORKS<span class="caret"></span></a>
                                <ul class="dropdown-menu multi-level">
                                    <li><a href="#">Codeignitor Framework</a></li>
                                    <li><a href="#">Laravel Framework</a></li>
                                </ul>
                            </li>
                            <li>
                              <a href="liveDemoCode.php" role="button">LIVE DEMO </a>
                            </li>
                            <!--
                            <li class="dropdown mega-dropdown mega-tabs">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="news_blog.php">PROJECT <span class="caret"></span></a>
                            ...
                            <li class="dropdown mega-dropdown mega-tabs">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="Kanpurize_jobs.php">Jobs <span class="caret"></span></a>
                                <div class="mega-menu dropdown-menu multi-level row bg-menu">
                                    <div class="tab-box" data-tab-anima="fade-left">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#">Components</a></li>
                        ...
                        <div class="nav navbar-nav navbar-right">
                            <ul class="nav navbar-nav lan-menu">
                                ...
                                <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><img src="admin.jpg" style="height:20px; width:20px;">Jitendra sahu <span class="caret"></span></a>
                                <ul class="dropdown-menu multi-level">
