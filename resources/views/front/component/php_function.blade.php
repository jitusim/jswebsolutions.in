				 ...
				 if($post_function != FALSE){
				     foreach($post_function as $p_action){
						...
						<div class="notice notice-warning ">
                           <a href="<?php echo url("php_codes/$p_action->title_url"); ?>" style="text-decoration:none;" class="anchor"><p style="" class="side_title"><?php if(!empty($p_action->title))echo $p_action->title; ?></p></a>
                        </div>
						<?php
					  }
				   }
