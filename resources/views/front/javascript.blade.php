            ...
            <div class="panel-body">
               ...
               <div class="row panel panel-default padding_div">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                     <h1 class="titleList">{{$post->title??"N/A"}}</h1>
                     ...
                     <div>
                        <a target="_blank" href="{{url("post/$post->title_url")}}" class="btn btn-default">Read more...</a>
                          @if(!empty($post->demoUrl))
                            <a target="_blank" href="{{$post->demoUrl}}" class="btn btn-default">See Demo</a>
                          @endif
                        <ul class="shareListing">
                          <li>
                             <a target="_blank" href="https://www.facebook.com/sharer.php?u=http://jswebsolutions.in/blogPost/<?php echo $post->title; ?>">
                              <i class="fa fa-facebook-square" aria-hidden="true"></i>
                            </a>
                          </li>
                          <li>
                             <a href="https://plus.google.com/share?url=http://jswebsolutions.in/blogPost/<?php echo $post->title; ?>" target="_blank"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a>
                          </li>
                        </ul>
                     </div>
                  </div>
