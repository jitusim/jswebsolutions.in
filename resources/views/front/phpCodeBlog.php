...
<div class="container">
					...
					<div class="panel-body">
					  <?php
                       ...
                       <?php
				        ...
				        <img src="<?php echo base_url("uploadsFiles/postImage/$image"); ?>" alt="create , Insert ,update,delete Opearation" class="img-thumbnail img-responsive">
			          </div>
							<?php
						  }
					   ?>
	...
	<div class="col-sm-6 col-md-4 col-lg-4 panel-body">
	 <?php
		$this->load->view('front/php_function');
     ?>
    </div> 
</div>
</div>